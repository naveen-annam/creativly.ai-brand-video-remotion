...
> **52 seconds. 17 scenes. 12,000+ lines of React. Every frame generated by code.**

A fully programmatic brand video for [Creativly.ai](https://www.creativly.ai) — the open-source creative AI platform. No After Effects. No timeline editors. Just React, [Remotion](https://remotion.dev), and [Claude Code](https://claude.ai/claude-code).
...
Every animation — spring entrances, bezier edge draws, waveform equalizers, noise-driven cursor drift, kinetic typography — runs on `useCurrentFrame()`. Zero CSS transitions. Zero keyframes. Pure Remotion.
